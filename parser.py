...
class KParseArgs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--text", help="Type in your review", nargs='?', action='store', default='this film was horrible, bad acting, even worse direction', type=str)
        self.parser.add_argument("--model_path", help="model_loading", nargs='?', action='store', default='models/base_line/base_line.h5', type=str)
        self.parser.add_argument("--tokenizer_path", help="tokenizer loading", nargs='?', action='store', default='models/base_line/tokenizer.pickle', type=str)
